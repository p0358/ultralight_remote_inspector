...
RefPtr<View> InspectorApp::OnCreateInspectorView(ultralight::View* caller, bool is_local,
...
void InspectorApp::OnClose(ultralight::Window* window) {
...
void InspectorApp::OnResize(ultralight::Window* window, uint32_t width, uint32_t height) {
	///
...
void InspectorApp::OnFinishLoading(ultralight::View* caller,
	uint64_t frame_id,
	bool is_main_frame,
	const String& url) {
	///
...
void InspectorApp::OnDOMReady(ultralight::View* caller,
	uint64_t frame_id,
	bool is_main_frame,
	const String& url) {
	///
...
void InspectorApp::OnChangeCursor(ultralight::View* caller,
	Cursor cursor) {
	///
...
void InspectorApp::OnChangeTitle(ultralight::View* caller,
	const String& title) {
	///
